...
def query_get_task_with_details(bot_memo,present_skill,bot_nlp):
    ...
    if ((bot_memo == {} or bot_memo['index']) and present_skill == 'get_task'):
        ...
        if ((len(body1["d"]["results"])==1)):
            ...
            return final_reply_string,bot_memo['index'] + 1,instance_id,created_by_user,SupplierName, (PurchaseOrderNetAmount + ' ' + DocumentCurrency),'',all_item_details
    ...
    #         return final_reply_string,bot_memo['index'],len(body1["d"]["results"]),created_by_user,SupplierName, (PurchaseOrderNetAmount + ' ' + DocumentCurrency)
        ...
        print('///////////////////////////////////////////////////')
        nlp_ordinal_filter_index = bot_nlp['ordinal'][bot_memo['index']-1]['index']  #this is the first element's index of nlp entity ordinal array
        ...
        # print(bot_nlp['ordinal'][bot_memo['index']-1]['index'])
        # print(type(bot_nlp['ordinal'][bot_memo['index']-1]['index']))
