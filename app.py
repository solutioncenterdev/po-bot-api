    ...
    if ((bot_memo == {} or bot_memo['index']) and present_skill == 'get_task'):
        ...
        if (body1["d"]["results"]):
            ...
            if (len(final_batch_instance_id_list) <= 0):
                ...
                reply,index,body1["d"]["results"][0]["InstanceID"],created_by_user,SupplierName,PurchaseOrderNetAmount,after_approval_reply,all_item_details,no_of_line_items,scrapped_po_no, final_batch_instance_amount_dict,final_batch_instance_id_list = get_taskONEbyONE(bot_memo,present_skill,bot_nlp)
