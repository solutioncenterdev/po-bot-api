    ...
    if ((bot_memo == {} or bot_memo['index']) and present_skill == 'get_task'):
        ...
        if (body1["d"]["results"]):
            ...
            if (len(final_batch_instance_id_list) <= 0):
                ...
                final_reply_string = "you have, " + str(no_of_tasks) + " pending approvals.<break strength='x-strong'>" + "You can approve, " + str(len(final_batch_instance_id_list)) + " of them on the go</break>, since, you have approved similar purchase orders before. Say, yes, to approve them, or no to get your tasks one by one."
